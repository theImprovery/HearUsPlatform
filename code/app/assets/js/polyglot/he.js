...
polyglot.extend({
    ...
    "campaign":{
        ...
        "takeDown":{
            "areYouSure":"הקמפיין כרגע פומבי. לבטל את הפרסום שלו?",
            "explanation":"על מנת לפרסם את הקמפיין שוב, תדרשו להגיש בקשת פרסום - לא ניתן להחזיר קמפיין לפרסום באופן מיידי.",
            "failed":"ביטול פרסום הקמפיין נכשל. הקמפיין עדיין מפורסם."
        }
    },
    "invitation": {
    ...
    campaignMgr:{
        content: {
            copyToAll: {
                title:"לשכפל נוסח זה לשאר הנוסחים?",
                text:"נוסחים קיימים ימחקו. אפשר גם לשכפל רק לנוסחים הריקים, בעזרת הכפתור השני."
            },
            success:"ההודעה הועתקה"
        }
    },
    warning: {
        unsaved: {
